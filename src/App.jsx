      ...
      <div className="container">
        ...
        <div className="inputBox">
          <textarea onChange={(e) => { setPrompt(e.target.value) }} value={prompt} placeholder='Tell me about your website in detail'></textarea>
          {
            prompt !== "" ?
              <>
                <i onClick={getResponse} className='sendIcon text-[20px] w-[30px] h-[30px] flex items-center justify-center bg-[#9933ff] rounded-[50%] transition-all duration-300 hover:opacity-[.8]'><MdArrowUpward /></i>
              </> : ""
          }
        </div>
